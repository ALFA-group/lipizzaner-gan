...
CUDA_VISIBLE_DEVICES=1 python main.py train --distributed --master -f configuration/quickstart/mnist-25.yml
sleep $sleep_time ; CUDA_VISIBLE_DEVICES=1 python main.py train --distributed --master -f configuration/quickstart/mnist-25.yml
sleep $sleep_time ; CUDA_VISIBLE_DEVICES=1 python main.py train --distributed --master -f configuration/quickstart/mnist-25.yml
sleep $sleep_time ; CUDA_VISIBLE_DEVICES=1 python main.py train --distributed --master -f configuration/quickstart/mnist-25.yml
sleep $sleep_time ; CUDA_VISIBLE_DEVICES=1 python main.py train --distributed --master -f configuration/quickstart/mnist-25.yml
sleep $sleep_time ; CUDA_VISIBLE_DEVICES=1 python main.py train --distributed --master -f configuration/quickstart/mnist-25.yml
