...
CNN-based SGAN to train the generator and the discriminator to generate and classify CIFAR-10 dataset samples.
"""
import argparse
import os
import numpy as np
...
def main():
    ...
    parser.add_argument(
        "--dataset_name", type=str, default="cifar10", help="dataset to be used for our experiments: cifar10"
    )
