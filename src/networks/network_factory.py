    ...
    def create_discriminator(self, parameters=None, encoded_parameters=None):
        net = SSDiscriminatorNet(
            ...
            Sequential(
                ...
                nn.Dropout2d(0.3),
                nn.LeakyReLU(0.2, inplace=True),
                Weight_norm(nn.Conv2d(192, 384, 3, 1, 1), name='weight'),
                # nn.BatchNorm2d(self.complexity * 2),
                # nn.Dropout2d(0.1),
                nn.LeakyReLU(0.2, inplace=True),
                ...
                nn.Dropout2d(0.3),
                nn.LeakyReLU(0.2, inplace=True),
                Weight_norm(nn.Conv2d(384, 768, 3, 1, 1), name='weight'),
                # nn.BatchNorm2d(self.complexity * 4),
                # nn.Dropout2d(0.1),
                nn.LeakyReLU(0.2, inplace=True),
                Weight_norm(nn.Conv2d(768, 768, 3, 2, 1), name='weight'),
                # nn.BatchNorm2d(self.complexity * 8),
                nn.Dropout2d(0.3),
                nn.LeakyReLU(0.2, inplace=True),
                Weight_norm(nn.Conv2d(768, 768, 3, 2, 1), name='weight'),
            ...
            Sequential(Weight_norm(nn.Conv2d(768, self.num_classes + 1, 4, 1, 0), name='weight')),
            self.gen_input_size,
