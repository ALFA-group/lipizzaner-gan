...
class GreedyEnsembleGenerator:
    ...
    def get_next_generator_path(self):
        ...
        if self.generator_index < self.generators_in_path:
            path = "{}/{}-{:03d}.pkl".format(
                self.generators_path, self.generators_prefix, int(self.generators_list[self.generator_index]),
            )
    ...
    def show_experiment_configuration(self):
        ...
        if self.output_file != "":
            self.show_file_screen(text, self.output_file)
        ...
        while True:
            ...
            for tentative_mixture_definition in combinations_of_weights:
                ...
                dataset = MixedGeneratorDataset(
                    population, mixture_definition, n_samples, self.mixture_generator_samples_mode,
                )
                ...
                text = (
                    "Generators examined={} - Mixture: {} - FID={}, TVD={}, FIDi={}, TVDi={}, FIDbest={}, "
                    "TVDbest={}".format(
                        generators_examined,
                        mixture_definition,
                        fid,
